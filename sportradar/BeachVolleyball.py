...
class BeachVolleyball(API):
    ...
    def __init__(self, api_key, format_='json', language='en', timeout=5, sleep_time=1.5):
        ...
        self.api_root = 'https://api.sportradar.us/volleyball-t1/beach/' + self._LANGUAGE + '/'
    ...
    def get_competitor_results(self, competitor_id):
        ...
        path = "competitors/{competitor_id}/results".format(
            competitor_id=competitor_id)
        return self._make_request(path)

    def get_competitor_schedule(self, competitor_id):
        """Provides the schedule for a given competitor"""
        path = "competitors/{competitor_id}/schedule".format(
            competitor_id=competitor_id)
        return self._make_request(path)
    ...
    def get_live_standings(self, tournament_id):
        ...
        path = "tournaments/{tournament_id}/live_standings".format(
