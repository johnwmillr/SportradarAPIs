...
class Darts(API):
    ...
    def get_competitor_profile(self, competitor_id):
        ...
        path = "darts-t1/en/competitors/{competitor_id}/profile".format(
    ...
    def get_competitor_results(self, competitor_id):
        ...
        path = "darts-t1/en/competitors/{competitor_id}/results".format(
            competitor_id=competitor_id)
        print(path)
        return self._make_request(path)
    ...
    def get_competitor_schedule(self, competitor_id):
        ...
        path = "darts-t1/en/competitors/{competitor_id}/schedule".format(
            competitor_id=competitor_id)
        print(path)
        return self._make_request(path)
    ...
    def get_daily_results(self, year, month, day):
        ...
        path = "darts-t1/en/schedules/{year:4d}-{month:02d}-{day:02d}/results".format(
    ...
    def get_daily_schedule(self, year, month, day):
        ...
        path = "darts-t1/en/schedules/{year:4d}-{month:02d}-{day:02d}/schedule".format(
            year=year, month=month, day=day)
        print(path)
        return self._make_request(path)
    ...
    def get_head_to_head(self, competitor_id1, competitor_id2):
        ...
        path = "darts-t1/en/competitors/{competitor_id1}/versus/{competitor_id2}/matches".format(
    ...
    def get_live_schedule(self):
        ...
        path = "darts-t1/en/schedules/live/schedule".format()
        print(path)
        return self._make_request(path)

    def get_seasons(self, tournament_id):
        """Provides the seasons for a given Tournament"""
        path = "darts-t1/en/tournaments/{tournament_id}/seasons".format(
    ...
    def get_sport_event_probabilities(self, match_id):
        ...
        path = "darts-t1/en/sport_events/{match_id}/probabilities".format(
            match_id=match_id)
        print(path)
        return self._make_request(path)
    ...
    def get_sport_event_timeline(self, match_id):
        ...
        path = "darts-t1/en/sport_events/{match_id}/timeline".format(match_id=match_id)
        print(path)
        return self._make_request(path)

    def get_tournament_info(self, tournament_id):
        """Provides a list of Competitors from a given Tournament"""
        path = "darts-t1/en/tournaments/{tournament_id}/in".format(
            tournament_id=tournament_id)
        print(path)
        return self._make_request(path)
    ...
    def get_tournament_results(self, tournament_id):
        ...
        path = "darts-t1/en/tournaments/{tournament_id}/results".format(
            tournament_id=tournament_id)
        print(path)
        return self._make_request(path)
    ...
    def get_tournament_schedule(self, tournament_id):
        ...
        path = "darts-t1/en/tournaments/{tournament_id}/schedule".format(
            tournament_id=tournament_id)
        print(path)
        return self._make_request(path)
    ...
    def get_tournament_standings(self, tournament_id):
        ...
        path = "darts-t1/en/tournaments/{tournament_id}/standings".format(
            tournament_id=tournament_id)
        print(path)
        return self._make_request(path)
