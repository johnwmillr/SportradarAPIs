...
class Cricket(API):
    ...
    def get_tournament_standings(self, tournament):
        ...
        path = "cricket-t2/en/tournaments/{tournament}/standings".format(
            tournament=tournament)
        return self._make_request(path)