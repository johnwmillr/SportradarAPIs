...
class eSportsLoL(API):
    ...
    def __init__(self, api_key, access_level='t', language='en',
        ...
        self.version = 1
        self.prefix = 'lol-{level}{ver}/{lang}/'.format(
    ...
    def get_deletedmatches(self, language_code):
    ...
    def get_teamresults(self, team_id):
        ...
        path = "teams/{team_id}/results".format(team_id=team_id)
        return self._make_request(self.prefix + path)

    def get_teamschedule(self, team_id):
        """Provides the schedule for a given team"""
        path = "teams/{team_id}/schedule".format(team_id=team_id)
        return self._make_request(self.prefix + path)
    ...
    def get_tournamentlivesummary(self, language_code):
    ...
    def get_tournaments(self, language_code):
        """Provides information for lol tournaments"""
        path = "tournaments"
        return self._make_request(self.prefix + path)
