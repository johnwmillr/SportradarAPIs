...
api_key_name = "API_KEY_SPORTRADAR"
api_key = os.environ.get(api_key_name, None)
assert (
    api_key is not None
), "Must declare environment variable: {key_name}".format(
    key_name=api_key_name
)
api = Handball.Handball(
    api_key, format_="json", language="en", timeout=5, sleep_time=2
)
...
class TestAPI(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.sport_event_id = (
            "sr:sport_event:34738527"  # TBV vs. VFL on the 01.09.2022
        )
